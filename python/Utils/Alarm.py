...
def GetTemplate(session,apartment,event):
    ...
    print "222222222.............................."
    for message_template in apartment.account.language.MessageTemplates:
        temp=ChooseTemplateByLanguage(temp, message_template, apartment, event)
    print "3333333333.............................."
    if default!=temp:   return temp
    print "444444444444.............................."
    for message_template in apartment.account.MessageTemplates:
        temp=ChooseTemplateByAccount(temp, message_template, apartment, event)
    print "5555555555555.............................."
    if default!=temp:   return temp
...
def ChooseTemplate(old,new,apartment,event):
    ...
    if old.sensor_model_id == event.device_key.device_model_id:
        if new.sensor_model_id !=event.device_key.device_model_id:   return old
    else:
        if new.sensor_model_id ==event.device_key.device_model_id:   return new
    ...
    if old.account_id == apartment.account_id:
        if new.account_id !=apartment.account_id:   return old
    else:
        if new.account_id ==apartment.account_id:   return new
    ...
    if old.language_id == apartment.account.language_id:
        if new.language_id !=apartment.account.language_id:   return old
    else:
        if new.language_id ==apartment.account.language_id:   return new
